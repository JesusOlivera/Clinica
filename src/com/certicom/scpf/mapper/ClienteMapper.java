...
public interface ClienteMapper {
	...
	@Select("select e.* from t_cliente e where e.numero_docu_iden_cab = #{nrodoc_cliente} limit 1")
	public Cliente findByFiltroNroDni(@Param("nrodoc_cliente") String filtro) throws Exception;
