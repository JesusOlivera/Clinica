...
public interface TicketMapper {
	...
	@Select("select t.*, pa.nombre as desPaciente, pr.descripcion_prod_det as desServicio, m.nombre_medico as desMedico from ((t_ticket t inner join t_paciente pa on pa.id_paciente = t.id_paciente) inner join t_producto pr on pr.id_producto = t.id_producto) inner join t_medico m on m.id_medico = t.id_medico order by t.id_ticket desc ")
	List<Ticket> findAll();
